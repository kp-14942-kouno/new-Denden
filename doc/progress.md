...
| Phase 10: エクスポート・レポート | 未着手 | - | - | - |
| Phase 11: テスト・品質保証 | 未着手 | - | - | - |
| Phase 12: デプロイ準備 | 未着手 | - | - | - |
...
- [ ] **11.1.1** テストプロジェクト作成（xUnit）
- [ ] **11.1.2** Repository層テスト
  - [ ] ProjectRepository
  - [ ] OperatorRepository
  - [ ] InquiryHistoryRepository
- [ ] **11.1.3** サービス層テスト
  - [ ] AuthenticationService
  - [ ] ConfigurationService
- [ ] **11.1.4** ViewModel層テスト
  - [ ] LoginViewModel
  - [ ] MainViewModel
...
- [ ] **11.2.1** ログインフロー
- [ ] **11.2.2** 顧客検索 → 問合せ登録フロー
- [ ] **11.2.3** 問合せ履歴検索 → 更新フロー
- [ ] **11.2.4** 顧客紐付けフロー
- [ ] **11.2.5** CSV出力フロー
